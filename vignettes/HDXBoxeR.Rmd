...
robot_indexes_df(thP = tc_aP, th=tc_a, states=rev(names_states)[1:2], 
                    pvalue = 0.05, alpha=0.01)

#list of indexes 
inds<-robot_indexes(thP = tc_aP, th=tc_a, states=rev(names_states)[1:2], 
                    pvalue = 0.05, alpha=0.01) ###return indexes of peptide
...
robot_2states_indexes(thP = tc_aP, th=tc_a, states=rev(names_states)[1:2],indexes = inds, pvalue=0.001, alpha=0.001, ylim=c(-120, 120), xlim=c(50, 230))
