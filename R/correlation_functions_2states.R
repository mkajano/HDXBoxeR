...
nb_exch_deut<-function(df){
  ...
  nb_exch_deut<-c(c(df$End-df$Start)-str_count(df$Sequence,'P') )+
    as.numeric(substr(df$Sequence, 1, 1)=="P")
  return(nb_exch_deut)
}
...
a5<-output_tp(path, states = names_states[c(5,9)], seq_match = F )
...
av5<-ave_timepoint(a5)
sd5<-sd_timepoint(a5)

plot(av5[,7]/nb_ex5, av5[,8]/nb_ex5, pch=20, xlab="", ylab="")
points(c(0,1), c(0,1), lty=2, type="l")
points(c(0,1), c(0,1)+0.04, lty=2, type="l")
points(c(0,1), c(0,1)-0.04, lty=2, type="l")
...
plot(av5[,7]/nb_ex5, pch=20)
points(av5[,8]/nb_ex5, col=2, pch=20)
points(av5[,9]/nb_ex5, col=4, pch=20)
points(av5[,10]/nb_ex5, col=5, pch=20)
