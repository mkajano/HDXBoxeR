...
#' Returns csv with averages from analysis for deuteration uptake file, standard deviation for time courses.
#'
#' Returns information from analysis and save it as csv file.
#' Sets are compared to the first state in the input file.
#'
#' @param filepath path to All.Data.csv input from HDX-Examiner.
#' @param output_name name of the output in csv format.
#' @return csv with analysis for deuteration uptake: standard deviation, for all protein states for time courses.
#' @examples
#' file_nm<-system.file("extdata", "All_results_table.csv", package = "HDXBoxeR")
#' verbose_timecourse_output(file_nm, "output_file_name.csv")
#' @export
verbose_timecourse_output<-function(filepath, output_name){
